...
{
    public class Get : BaseAsyncEndpoint.WithRequest<Guid>.WithResponse<PurchaseItemListResponse>
    {

        [HttpGet("/purchaseitems/one/{id}")]
        public override async Task<ActionResult<PurchaseItemListResponse>> HandleAsync(Guid id, CancellationToken cancellationToken = default)
        {
